...
from checks.s3dis.check_s3dis_pointnext_s_strict_load import extract_state_dict
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output_dir",
        default=str(REPO_ROOT / "work_dirs" / "_s3dis_pointnext_s_single_room_inference"),
    )
