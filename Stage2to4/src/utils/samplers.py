# COPIED FROM facebookresearch/dinov3
#
...
class InfiniteSampler(Sampler):
    ...
    def set_epoch(self, epoch, effective_epoch_length=None):
        if epoch is not None:
            if effective_epoch_length is not None:
                self._advance = epoch * effective_epoch_length
            else:
                self._advance = self._sample_count * epoch
