...
echo "Stage 4 Phase 5-B all-Phase3 CVAT review export"
...
"${PYTHON}" \
  ...
  --output_root "${PHASE5_REVIEW_ROOT}" \
...
echo
echo "Stage 4 Phase 5-B export complete."
echo "  review index : ${PHASE5_REVIEW_ROOT}/review_index.csv"
echo "  progress     : ${PHASE5_REVIEW_ROOT}/progress.csv"
echo "  video tasks  : ${PHASE5_REVIEW_ROOT}/videos"
echo "  summary      : ${PHASE5_REVIEW_ROOT}/partition_summary.json"
